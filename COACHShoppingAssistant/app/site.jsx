  ...
  return (
    <div className="ca-teaser" style={{ position: 'absolute', zIndex: 29, right: 18, bottom: 86, maxWidth: 248, background: '#fff', color: '#111',
      ...
      <div style={{ display: 'flex', gap: 9, alignItems: 'flex-start' }}>
        <span style={{ flex: '0 0 auto', width: 26, height: 26, borderRadius: '50%', background: '#000', color: '#fff', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><Ic.Chat size={15} stroke={1.7} /></span>
        <div>
