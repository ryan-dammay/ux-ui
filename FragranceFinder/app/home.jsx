...
function HomeHeader({ store }) {
  ...
  return (
    <div style={{ padding: "8px 20px 0", background: "#fff" }}>
      ...
      {/* category tabs — full-bleed horizontal carousel */}
      <div style={{ display: "flex", gap: 22, margin: "14px -20px 0", padding: "0 20px 2px", overflowX: "auto" }} className="no-scrollbar">
        {cats.map(c => (
          <span key={c} style={{
            fontSize: 17, whiteSpace: "nowrap", paddingBottom: 8, flexShrink: 0,
