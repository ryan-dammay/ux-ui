      ...
      <div style={{ display: "flex", justifyContent: "space-between", gap: 16 }}>
        <div>
          <button onClick={() => onOpenDesigner && onOpenDesigner(product.brand)} style={{
            ...
            <span style={{ fontSize: 16, fontWeight: 700, lineHeight: 1.3 }}>{product.brand}</span>
          </button>
  ...
  return (
    <div style={{ padding: "4px 16px 0", display: "flex", flexDirection: "column", gap: 10 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        {product.stock <= 6 && <span style={{ marginLeft: "auto", fontSize: 12, fontWeight: 600, color: "#c4574a" }}>Only {product.stock} left</span>}
      </div>
    </div>
  );
}
